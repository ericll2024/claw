...
def load_config() -> dict:
    ...
    try:
        ...
        content = db.get_setting("file:state/mfdb/market_business_analysis_check_config.json", "")
        if not content:
            content = db.get_setting("file:code/state/mfdb/market_business_analysis_check_config.json", "")
        if content:
